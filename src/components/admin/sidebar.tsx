...
const items=[
  ...
  ["/admin/automation","Автоматизация",Workflow],["/admin/publication","Автопубликация",Rocket],["/admin/collections","Подборки",Sparkles],["/admin/shares","Аналитика интереса",BarChart3],["/admin/categories","Категории",Shapes],["/admin/organizers","Организаторы",UsersRound],["/admin/collector-runs","История сборов",History],["/admin/errors","Ошибки системы",Database],
] as const;
