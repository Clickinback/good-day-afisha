...
import { BarChart3,CalendarDays,Database,FileJson2,GitMerge,History,LayoutDashboard,MapPinned,MessageSquareWarning,Radio,Rocket,Sparkles,Shapes,UsersRound,Warehouse,Workflow } from "lucide-react";
...
const items=[
  ...
  ["/admin/automation","Автоматизация",Workflow],["/admin/publication","Автопубликация",Rocket],["/admin/collections","Подборки",Sparkles],["/admin/shares","Статистика публикаций",BarChart3],["/admin/categories","Категории",Shapes],["/admin/organizers","Организаторы",UsersRound],["/admin/collector-runs","История сборов",History],["/admin/errors","Ошибки системы",Database],
] as const;
