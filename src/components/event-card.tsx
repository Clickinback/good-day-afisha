  ...
  return (
    <article className="event-card">
      <Link href={`/${event.city.slug}/events/${event.slug}`} className="event-image">
        <Image className="event-image-foreground" src={event.imageUrl} alt="" width={800} height={1200} sizes="(max-width: 600px) 92vw, (max-width: 900px) 45vw, (max-width: 1100px) 31vw, 24vw" priority={priority} />
